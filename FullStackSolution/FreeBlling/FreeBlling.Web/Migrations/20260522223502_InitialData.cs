...
namespace FreeBlling.Web.Migrations
{
    /// <inheritdoc />
    public partial class InitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 220.0, "mary@feebilling.com", "/img/mary.jpg", "Mary Jones" },
                    { 2, 85.0, "betty@feebilling.com", "/img/betty.jpg", "Betty Patel" },
                    { 3, 115.0, "nancy@feebilling.com", "/img/nancy.jpg", "Nancy Smith" },
                    { 4, 145.0, "john@feebilling.com", "/img/john.jpg", "John Phillips" }
                });
