...
namespace FreeBlling.Web.Controllers
{
    ...
    public class CustomersTimeBillsController : ControllerBase
    {
        ...
        public CustomersTimeBillsController(ILogger<CustomersTimeBillsController> logger, IBillingRepository repository)
        {
            _logger = logger;
        ...
        {
            var result = await _repository.GetTimeBillsForCustomer(id, billId);
